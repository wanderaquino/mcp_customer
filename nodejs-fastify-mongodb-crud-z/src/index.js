...
const adminSuperSecret = "adminsupersecret";
...
console.log(`Service token for ${user.username} with role ${role}:`, serviceToken);
console.log('Create customer response body:', await createCustomerResponse.json(), role); */